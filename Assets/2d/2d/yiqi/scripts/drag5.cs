...
//给空间添加监听事件要实现的一些接口
public class drag5 : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler, 
IEndDragHandler, IPointerEnterHandler, IPointerExitHandler {
	...
	Vector3 imgReduceScale = new Vector3(0.56f, 1.2f, 1);   //设置图片缩放
	Vector3 imgNormalScale = new Vector3(0.66f,1.3f, 1);   //正常大小
