...
public class zidrag : MonoBehaviour ,IBeginDragHandler, IDragHandler,IEndDragHandler{//实现开始拖拽，拖拽中和结束拖拽3个事件接口
	...
	public void OnBeginDrag(PointerEventData eventData)//开始拖拽
	{
		...
		dragObj.GetComponent<RectTransform>().sizeDelta = 
			new Vector2(Screen.height * 0.15f, Screen.height * 0.25f);//设置新生成物品的尺寸
