...
//给空间添加监听事件要实现的一些接口
public class drag4 : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler, 
IEndDragHandler, IPointerEnterHandler, IPointerExitHandler {
	...
	Vector3 imgReduceScale = new Vector3(2.9f, 3.9f, 1);   //设置图片缩放
	Vector3 imgNormalScale = new Vector3(3f,4, 1);   //正常大小

	// Use this for initialization
	void Start () {
		imgRect = GetComponent<RectTransform>();
		shi = GameObject.Find ("shiguan");
